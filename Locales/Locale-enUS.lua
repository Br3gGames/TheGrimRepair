local L = LibStub("AceLocale-3.0"):NewLocale("TGR", "enUS", true)

if L then
    L["AUTO_REPAIR_HEADER"] = "Auto Repair"
    L["AUTO_SELL_HEADER"] = "Auto Sell"
    L["KEEP_GRAY_DESC"] = "Keep gray armor and weapons for transmog"
    L["KEEP_GRAY_HEADER"] = "Keep transmog items (armor and weapons)"
    ...
    L["SELL_GRAY_HEADER"] = "Sell gray items"
